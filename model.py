...
class DensE(nn.Module):
    def __init__(self, args):
        ...
        self.gate1 = nn.Linear(self.args.width * 2 * self.args.embed_dim, 1)
        self.gate2 = nn.Linear(2 * self.args.embed_dim, 1)
        self.gate3 = nn.Linear(self.args.width * 2 * self.args.embed_dim, 1)
        self.gate4 = nn.Linear(2 * self.args.embed_dim, 1)
